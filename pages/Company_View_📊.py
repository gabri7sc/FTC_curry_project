...
st.set_page_config( page_title="Company's View", page_icon='📊', layout='wide' )
...
def second_container_tab1_col1( df1 ):
...
def second_container_tab1_col2( df1 ):

    # Filtering data
    aux = ( df1[['ID', 'City', 'Road_traffic_density']].groupby( ['City', 'Road_traffic_density'] )
            .count().reset_index() )
...
st.header( "Marketplace - Company's View" )
